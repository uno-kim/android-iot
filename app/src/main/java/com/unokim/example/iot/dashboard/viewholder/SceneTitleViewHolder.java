...
public class SceneTitleViewHolder extends BaseViewHolder {

    private DashboardItem mItem;
    private TextView mTitle;

    public SceneTitleViewHolder(@NonNull Context context,
            int layoutRes,
    ...
    public void bind(DashboardItem item) {
        mItem = item;
        mTitle.setText(String.format("%s", mItem.getName()));
